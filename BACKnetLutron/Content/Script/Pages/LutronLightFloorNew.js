...
function GetDeviceDetails(selectedValue) {
    //var deviceId = '1761035';
    $.get("api/LutronLightFloor/GetDeviceDetails/" + deviceId, function (deviceDetail) {
...
function SetLightingScene(selectedValue) {
    ...
    $.post("api/LutronLightFloor/SetLightingScene/", lightscene, function (deviceDetail) {
        var detail = deviceDetail;
    }).success(function (detail) {
        SetLightStatus(detail);
    });
...
function SetLightingLevel(selectedValue, deviceId) {
    ...
    $.post("api/LutronLightFloor/SetLightingLevel/", lightLevel, function (deviceDetail) {
        var detail = deviceDetail;
    }).success(function (detail) {
        SetLightStatus(detail);
    });
